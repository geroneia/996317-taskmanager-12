...
import TaskPresenter, {State as TaskPresenterViewState} from "../presenter/task.js";
...
export default class Board {
  ...
  _renderLoadMoreButton() {
    // сначала сбрасывается, потом отрисовывается?
  ...
  _clearBoard({resetRenderedTaskCount = false, resetSortType = false} = {}) {
    ...
    if (resetRenderedTaskCount) {
      ...
      // в случае удаления или переноса карточки в архив - корректируется количество показанных задач
  ...
  _renderBoard() {
    ...
    // добавляет возможность хранить количество показанных карточек при перерисовке
