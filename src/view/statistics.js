...
const renderColorsChart = (colorsCtx, tasks) => {
  ...
  return new Chart(colorsCtx, {
    ...
    type: `pie`,
    data: {
      labels: uniqColors, // ярлыки - названия уникальных цветов
      datasets: [{
        data: taskByColorCounts, // количество задач по каждому цвету
...
const renderDaysChart = (daysCtx, tasks, dateFrom, dateTo) => {
  ...
  return new Chart(daysCtx, {
    ...
    type: `line`,
    data: {
      labels: parsedDates, // названия дней
      datasets: [{
        data: taskInDateRangeCounts, // количество задач по каждому дню
